...
**Adat alap statisztikái**: **39797** adat pont, **61** változó, amiből **1** a célváltozó, **2** azonosító, és a maradék **58** prediktív, nincs hiányzó adat. Az adat létrehozásának ideje **January 8, 2015**. Bizonyos változók már adatbányászati algoritmusok felhasználásával jöttek létre.
